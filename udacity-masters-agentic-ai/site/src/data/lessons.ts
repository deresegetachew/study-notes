...
export const LESSONS: LessonEntry[] = [
  ...
  { href: '/lessons/0006-how-the-model-actually-works',         num: '2.3', title: 'How the Model Actually Works' },
  { href: '/lessons/0007-branching-paths-beam-search',          num: '2.4', title: 'Branching Paths: Beam Search' },
];
