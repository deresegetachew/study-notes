...
The agent is designed for long-running tasks with progress callbacks
to support polling-based API patterns.
"""
...
if __name__ == "__main__":
    ...
    test_query = "What AI products were launched by the company that acquired DeepMind in 2024?"
    print(f"\nTesting with query: {test_query}\n")

    result = run_task_decomposition(test_query, on_progress=print_progress)
